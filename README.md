...
[![Container size](https://ghcr-badge.egpl.dev/emarsden/dash-mpd-cli/size?label=Container%20image)](https://ghcr-badge.egpl.dev/emarsden/dash-mpd-cli/size?label=Container%20image)
